...
import { Hammer, Mail, Lock, Building, AlertTriangle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#09090b] overflow-hidden px-4">
      ...
      <div className="relative w-full max-w-md my-8 z-10">
        ...
        >
          <h2 className="text-xl font-bold text-white mb-6">Create Manager Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-1.5" htmlFor="signup-company">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Oak & Iron Carpentry"
                  className="w-full pl-10 pr-4 py-2.5 bg-zinc-900/20 border border-white/5 rounded-xl text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-1.5" htmlFor="signup-email">
                Manager Email
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-zinc-500">
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-1.5" htmlFor="signup-password">
                Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-zinc-500">
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-1.5" htmlFor="signup-confirm-password">
                Confirm Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-zinc-500">
